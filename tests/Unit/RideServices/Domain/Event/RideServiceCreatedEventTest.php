...
class RideServiceCreatedEventTest extends RideServicesTestCase
{
    ...
    public function test_event_name(): void
    {
        ...
        $this->assertEquals('rideServices.domain.rideService.v1.create', $event->eventName());
    }
    ...
    private function getEvent(RideService $rideService = null): RideServiceCreatedEvent
    {
